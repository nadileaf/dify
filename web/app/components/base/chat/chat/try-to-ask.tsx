...
const TryToAsk: FC<TryToAskProps> = ({
  ...
  return (
    <div className='mb-2 py-2'>
      <div className={cn('mb-4 flex items-center justify-between gap-2', isMobile && 'justify-end')}>
      ...
      <div className={cn('flex flex-wrap justify-center gap-2', isMobile && 'justify-end')}>
        {
